...
ARGS = ['database_migration_dir', 'database_table', 'database_type', 'database_host',
        ...
        'database_collation', 'database_trusted_connection', 'schema_file', 'checksum_file',
        'config', 'version', 'cmd']
...
class Settings():
    ...
    def parse_arguments(self) -> ConfigFile:
        ...
        parser.add_argument("--database-type", help="Database type [postgres|mysql|duckdb|sqlite|sqlserver]")
